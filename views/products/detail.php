                    ...
                    <li class="splide__slide">
                        <div class="card" style="width: 18rem;">
                            ...
                            <a class="wishlist-btn card-text position-absolute end-0 mt-2 me-3"
                                ...
                                data-status="<?= (($wishlist->product_id == $filter_product->id) && ($wishlist->status == 1)) ? 1 : 0 ?>">
                                <?= (($wishlist->product_id == $filter_product->id) && ($wishlist->status == 1)) ? '<i class="fa-solid fa-heart"></i>' : '<i class="fa-regular fa-heart"></i>' ?>
                            </a>
                            <?php endforeach; ?>
                            <?php else: ?>
                            <a class="wishlist-btn card-text position-absolute end-0 mt-2 me-3"
